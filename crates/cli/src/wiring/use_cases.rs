...
use ferrous_dns_application::use_cases::{
    ...
    CreateRegexFilterUseCase, CreateScheduleProfileUseCase, CreateWhitelistSourceUseCase,
    ...
    DeleteRegexFilterUseCase, DeleteSafeSearchConfigsUseCase, DeleteScheduleProfileUseCase,
...
pub struct UseCases {
    ...
    pub test_domain: Arc<TestDomainUseCase>,
    pub backtest: Arc<BacktestBlocklistsUseCase>,
...
impl UseCases {
    pub fn new(
        ...
        Self {
            ...
            test_domain: Arc::new(TestDomainUseCase::new(repos.block_filter_engine.clone())),
