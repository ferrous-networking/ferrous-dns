    ...
    Json(ConfigResponse {
        ...
        dns: DnsConfigResponse {
            ...
            rate_limit: crate::dto::config::RateLimitConfigResponse {
                ...
                ipv4_prefix_len: config.dns.rate_limit.ipv4_prefix_len,
                ipv6_prefix_len: config.dns.rate_limit.ipv6_prefix_len,
                whitelist: config.dns.rate_limit.whitelist.clone(),
                nxdomain_per_second: config.dns.rate_limit.nxdomain_per_second,
                slip_ratio: config.dns.rate_limit.slip_ratio,
                dry_run: config.dns.rate_limit.dry_run,
