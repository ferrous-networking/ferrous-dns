...
impl JobRunner {
    ...
    pub fn with_schedule_evaluator(mut self, job: ScheduleEvaluatorJob) -> Self {
        self.schedule_evaluator = Some(job);
        self
    }
    ...
    pub fn with_tunneling_eviction(mut self, job: TunnelingEvictionJob) -> Self {
        self.tunneling_eviction = Some(job);
        self
    }
